...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Erkek rolünü ayarlama
        const erkekRol = interaction.options.getRole('rol');

        // Ayarları kaydetme
        saveSettings(guild.id, { erkekRolId: erkekRol.id });

        // Embed mesajı oluşturma
        const embed = new MessageEmbed()
            .setColor('#30cb74')
            .setTitle('<:sucses:1243275119414214756> Erkek Rolü Ayarlandı')
            .setDescription(`Erkek rolü başarıyla ${erkekRol} olarak ayarlandı!`)
            .setTimestamp();
